...
import {setNumberOfPlayers} from '../../../src/redux/games/keyGuess/keyGuessSlice';

const EnterNumberOfPlayersKeyGuess = () => {
  const navigation = useNavigation();
  const dispatch = useDispatch();
  const selected = useSelector(state => state.keyGuess.numberOfPlayers);
        ...
        <View style={styles.optionContainer}>
          ...
          <View style={styles.buttonContainer}>
            <ColorGuessButton
              ...
              textColor="#333"
              borderRadius={20}
              onPress={() => navigation.navigate('PlayerKeyGuessNames')}
            />
          </View>
        </View>
      </View>
...
export default EnterNumberOfPlayersKeyGuess;
