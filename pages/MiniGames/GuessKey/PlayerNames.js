...
import {setPlayerNames} from '../../../src/redux/games/keyGuess/keyGuessSlice';

const PlayerKeyNames = () => {
  const navigation = useNavigation();
  const dispatch = useDispatch();
  const numberOfPlayers = useSelector(state => state.keyGuess.numberOfPlayers);
  const playerNames = useSelector(state => state.keyGuess.playerNames);
        ...
        <View style={styles.buttonContainer}>
          <ColorGuessButton
            ...
            onPress={() => {
              ...
              setError('');
              navigation.navigate('DifficultyKeyGuessPage');
            }}
          />
          {error ? (
