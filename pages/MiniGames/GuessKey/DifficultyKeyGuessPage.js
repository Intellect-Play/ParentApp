...
import {
  ...
  HARD_MODE,
  MEDIUM_MODE,
} from '../../../gameSettings/keyGuess/settings';
import {setDifficulty} from '../../../src/redux/games/keyGuess/keyGuessSlice';

const DifficultyKeyGuessPage = () => {
  const dispatch = useDispatch();
  const selectedDifficulty = useSelector(state => state.keyGuess.difficulty);
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <ColorGuessButton
          ...
          textColor="#333"
          borderRadius={20}
          onPress={() => navigation.navigate('KeyGuessWordsPage')}
        />
      </View>
    </SafeAreaView>
  );
...
export default DifficultyKeyGuessPage;
