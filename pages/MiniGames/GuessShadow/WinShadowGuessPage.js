...
const WinShadowGuessPage = ({route}) => {
  ...
  const scores = useSelector(state => state.shadowGuess.scores);
      ...
      <View>
            ...
            <View style={[styles.smallAvatarContainer, styles.relative]}>
              <View style={styles.avatarContainer}>
                ...
                <View style={styles.horizontalPlayerCircle}>
                  <Text style={styles.textColorCircle}>2</Text>
                </View>
              </View>
            </View>
          )}
            ...
            <View style={[styles.bigAvatarContainer, styles.relative]}>
              <View style={styles.avatarContainer}>
                ...
                <View style={styles.firstPlayerCircle}>
                  <Text style={styles.textColorCircle}>1</Text>
                </View>
          ...
          {third && (
            <View style={[styles.smallAvatarContainer, styles.relative]}>
              <View style={styles.avatarContainer}>
                ...
                <View style={styles.horizontalPlayerCircle}>
                  <Text style={styles.textColorCircle}>3</Text>
                </View>
              </View>
            </View>
          )}
        ...
        <View style={styles.buttonContainer}>
          ...
          <ColorGuessButton
            ...
            onPress={() => {
              dispatch(resetGame());
              navigation.navigate('GuessShadowPage');
            }}
          />
        </View>
      </View>
...
export default WinShadowGuessPage;
