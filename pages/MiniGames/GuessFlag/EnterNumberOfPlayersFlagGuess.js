...
import {setNumberOfPlayers} from '../../../src/redux/games/flagGuess/flagGuessSlice';

const EnterNumberOfPlayersFlagGuess = () => {
  const navigation = useNavigation();
  const dispatch = useDispatch();
  const selected = useSelector(state => state.flagGuess.numberOfPlayers);
      ...
      <View style={styles.optionContainer}>
        ...
        <View style={styles.buttonContainer}>
          <ColorGuessButton
            ...
            textColor="#333"
            borderRadius={20}
            onPress={() => navigation.navigate('PlayerFlagGuessNames')}
          />
        </View>
      </View>
    </View>
...
export default EnterNumberOfPlayersFlagGuess;
