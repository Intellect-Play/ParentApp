...
import {
  ...
  HARD_MODE,
  MEDIUM_MODE,
} from '../../../gameSettings/FlagGuess/settings';
import {setDifficulty} from '../../../src/redux/games/flagGuess/flagGuessSlice';

const DifficultyFlagGuessPage = () => {
  const dispatch = useDispatch();
  const selectedDifficulty = useSelector(state => state.flagGuess.difficulty);
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <ColorGuessButton
          ...
          textColor="#333"
          borderRadius={20}
          onPress={() => navigation.navigate('FlagGuessWordsPage')}
        />
      </View>
    </SafeAreaView>
  );
...
export default DifficultyFlagGuessPage;
