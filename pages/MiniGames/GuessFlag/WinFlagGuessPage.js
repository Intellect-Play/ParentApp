...
const WinFlagGuessPage = ({route}) => {
  const {winner} = route.params;
  const scores = useSelector(state => state.flagGuess.scores);
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <ColorGuessButton
          ...
          onPress={() => {
            dispatch(nextPlayer());
            navigation.replace('FlagGuessWordsPage');
          }}
        />
        <ColorGuessButton
          width={300}
          ...
          onPress={() => {
            dispatch(resetGame());
            navigation.navigate('GuessFlagPage');
          }}
        />
      </View>
    </SafeAreaView>
...
export default WinFlagGuessPage;
