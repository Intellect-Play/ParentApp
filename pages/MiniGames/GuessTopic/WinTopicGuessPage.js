...
import {resetGame} from '../../../src/redux/games/topicGuess/topicGuessSlice';

const WinTopicGuessPage = ({route}) => {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <ColorGuessButton
          ...
          onPress={() => {
            // dispatch(nextPlayer());
            navigation.navigate('TopicGuessCategoriesPage');
          }}
        />
        <ColorGuessButton
          width={300}
          ...
          onPress={() => {
            dispatch(resetGame());
            navigation.navigate('GuessTopicPage');
          }}
        />
      </View>
    </SafeAreaView>
...
export default WinTopicGuessPage;
