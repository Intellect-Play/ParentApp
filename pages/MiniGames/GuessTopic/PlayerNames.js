...
import {setPlayerNames} from '../../../src/redux/games/topicGuess/topicGuessSlice';

const PlayerTopicNames = () => {
  const navigation = useNavigation();
  const dispatch = useDispatch();
  const numberOfPlayers = useSelector(
    state => state.topicGuess.numberOfPlayers,
  );
        ...
        <View style={styles.buttonContainer}>
          <ColorGuessButton
            ...
            onPress={() => {
              ...
              setError('');
              navigation.navigate('DifficultyTopicGuessPage');
            }}
          />
          {error ? (
...
export default PlayerTopicNames;
